...
// Definiamo la versione del plugin come costante per un facile accesso
define( 'GCS_VERSION', '1.10.4' );
...
$myUpdateChecker = PucFactory::buildUpdateChecker(
    // Passiamo direttamente l'URL del repository GitHub.
    // La libreria controllerà automaticamente le "Releases" per le nuove versioni.
